...
traffic_consumer = RabbitMqTrafficConsumer(
    RABBITMQ_HOST, performance_detector, traffic_window, cold_start, port=RABBITMQ_PORT
)
...
def start_traffic_consumer() -> None:
    """RabbitMQ consumer'ı arka plan thread'inde başlatıyor, API'yi bloklamıyor"""
